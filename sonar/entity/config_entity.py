...
from sonar.constant import training_pipeline

class TrainingPipelineConfig:
    def __init__(self, timestamp=datetime.now()) -> None:
        timestamp = timestamp.strftime("%m_%d_%Y_%H_%M_%S")
        self.pipeline_name : str = training_pipeline.PIPELINE_NAME
        self.artifacts_dir : str = os.path.join(training_pipeline.ARTIFACT_DIR,timestamp)
        self.timestamp : str = timestamp

class DataIngestionConfig:
    """
    Creating directory for data ingestion directory
    """
...
class DataTransformationConfig:
    ...
    def __init__(self, training_pipeline_config:TrainingPipelineConfig) -> None:
        # this creates a directory inside the passed artifact dir.
        ...
        # this creates the directory inside the transformed dir
...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_evaluation_dir: str = os.path.join(
            training_pipeline_config.artifacts_dir, training_pipeline.MODEL_EVALUATION_DIR_NAME
        )
...
class ModelPusherConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_evaluation_dir: str = os.path.join(
            training_pipeline_config.artifacts_dir, training_pipeline.MODEL_PUSHER_DIR_NAME
        )
